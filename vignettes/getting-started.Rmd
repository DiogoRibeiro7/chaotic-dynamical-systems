...
3. Leadbetter, M. R. (1983). Extremes and local dependence in stationary sequences. *Zeitschrift für Wahrscheinlichkeitstheorie und verwandte Gebiete*, 65(2), 291-306.
...
✅ How to simulate chaotic dynamical systems
✅ How to perform extreme value analysis (block maxima & POT)
✅ How to estimate and interpret the extremal index
✅ How to select thresholds using diagnostic plots
