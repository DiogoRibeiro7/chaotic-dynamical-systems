#' Internal Kuramoto C++ kernel
#'
#' @param n_keep Number of retained RK4 steps.
#' @param n_transient Number of discarded RK4 steps.
...
#' @param coupling Diffusive coupling strength.
#' @param x0 Initial lattice state.
#' @param noise Matrix of pre-generated additive perturbations.
#' @return Numeric matrix of lattice states.
cml_simulate_cpp_impl <- function(n, r, coupling, x0, noise) {
    .Call(`_chaoticds_cml_simulate_cpp_impl`, n, r, coupling, x0, noise)
}
