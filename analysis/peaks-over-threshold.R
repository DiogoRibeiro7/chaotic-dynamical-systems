...
#'
#' @return Numeric vector of exceedances (values above threshold).
#' @examples
...
#'
#' @return Data frame with columns `threshold` and `mean_excess`.
#' @examples
